...
class AddCinema extends Component {
          ...
          seats.map((seat, index) => (
            <div key={`seat-${index}-${seat.length}`} className={classes.field}>
              <TextField
                ...
                label={
                  'Ajouter nombre de chaise par rangée : ' +
  ...
  render() {
    ...
    const mainTitle = this.props.editCinema ? 'Modifier Cinema' : 'Ajouter Cinema';
    const submitButton = this.props.editCinema
      ? 'Mise à jour du  Cinema'
      : 'Sauvegarder';
